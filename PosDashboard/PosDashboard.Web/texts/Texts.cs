    ...
    public static partial class Texts
    {
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static readonly LocalText ActivateEmailSubject = "Activate Your PosDashboard Account";
            ...
            public static readonly LocalText SiteTitle = "PosDashboard";
        }
        ...
        public static class Site
        {
            public static class OpenId
            {
                ...
                {
                    public static readonly LocalText worklog = "View and modify your work logs.";
                }
            }
